...
const RESEARCHES = {
  ...
  clearing: {
    ...
    get unAffordableText() {
      const clearText = Research.has("clearing", 2) ? ", and clear at least a <b style='color: #47b9ff'>3</b> tile." : "";
  ...
  access: {
    ...
    get unAffordableText() {
      ...
      return `Have at least 30 drill v1s placed. Progress: ${Number(format(player.buildingAmt[SPECIAL_CHARS.tri], 0))}/30`;
    },
    get canAfford() {
